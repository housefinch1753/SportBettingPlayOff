...
from nba_playoff_stats_visualizer.playoff_stats_finder import TeamGameFinder
...
st.title("Enhance Your Sports Betting Strategy - NBA Playoff Statistics Visualizer")
...
<ul>
<li>🔍 Select a season and team from the selection options to load their playoff statistics</li>
...
<p>📣 <strong>I am committed to continuous improvement!</strong> This tool will be actively updated with new features and data. 🔄</p>
</div>
""", unsafe_allow_html=True)

# Add selection options in the main page instead of sidebar
st.header("Selection Options", anchor=False)
